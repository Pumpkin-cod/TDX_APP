...
const Features = () => {
    return (
        <div className='mx-4 md:mx-32 my-8 md:my-16'>
            <div>
                <h1 className='text-black text-3xl md:text-5xl text-center mb-2'>Our Platform Features</h1>
            </div>
            <div>
                <p className='text-slate-400 text-lg md:text-xl text-center mb-4'>Secure, accessible, and up-to-date solutions for big markets
                    <br /> to connect with small farmers</p>
            </div>
            <div className='flex flex-col md:flex-row justify-between items-center'>
                <div className="border border-gray-300 rounded w-full md:w-56 flex flex-col justify-center items-center mb-4 md:mb-0">
                ...
                <div className="border border-gray-300 rounded w-full md:w-72 flex flex-col justify-center items-center mb-4 md:mb-0">
