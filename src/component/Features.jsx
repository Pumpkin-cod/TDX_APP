...
const Features = () => {
  return (
      <div className='mx-32 my-16'>
          <div>
              <h1 className='text-black text-5xl text-center mb-2'>Our Platform Features</h1>
          </div>
          <div>
              <p className='text-slate-400 text-xl text-center mb-4'>Secure, accessible and up to date solutions for big markets 
              <br /> to connect with small farmers</p>
          </div>
      <div className='flex flex-row justify-between items-center'>
              <div className="border border-gray-300 rounded w-56 flex flex-col justify-center items-center">
              ...
              <div className="border border-gray-300 rounded w-56 flex flex-col justify-center items-center">
                  ...
                  <div className="p-4">
                      ...
                      <p className="text-gray-700">Reduces  logistics costs associated with traditional sourcing methods
</p>
                  </div>
              </div>
              <div className="border border-gray-300 rounded w-56 flex flex-col justify-center items-center">
